...
namespace PacManGame
{
  public class LevelCore
  {
    ...
    //     public List<RowColumn> LevelWalls = new List<RowColumn> { 
    //         //row 0
    ...
    //     };
    //     //row3
    //     public List<RowColumn> LevelGaps = new List<RowColumn>{ new RowColumn(3,3),new RowColumn(3,4),new RowColumn(3,8),new RowColumn(3,9),new RowColumn(3,10),new RowColumn(3,17),new RowColumn(3,18), new RowColumn(3,19),new RowColumn(3,23),new RowColumn(3,24),
    //     //row 4
